...
resultPath ='C:/Users/wzhu/Dropbox/civs-frame/animalExpV3';
modelPath = 'C:/Users/wzhu/Dropbox/civs-frame/animalExpV3/models';
...
for iCate = 1:nCate
    ...
    parfor iTest=1:nTest
        testScoreMatrix(iCate,iTest)=testOneImageDistV3(testImageCell{iTest},alllambda,logZ,filters);
    end
    parfor iTrain = 1:nTrain
        trainScoreMatrix(iCate,iTrain)=testOneImageDistV3(trainImageCell{iTrain},alllambda,logZ,filters);
    end
