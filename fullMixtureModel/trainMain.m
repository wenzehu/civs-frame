...
resultPath ='~/Dropbox/civs-frame/animalExp'
modelPath = '~/Dropbox/civs-frame/animalExp/models';
cachePath = '~/Documents/civs-frame/animalExp/cache';
...
for iCate = 1:nCate
	...
	em_mixtureFRAMEFunc(cate_trainImgs,cate_model_path,cate_cache_path);
end
...
for iFilter = 1:numFilter
	filters{iFilter}=gpuArray(single(filters{iFilter}));
end
...
for iCate = 1:nCate
	...
	for iTest = 1:nTest
		...
		scoreMatrix(iCate,iTest)=testOneImage(imgName,alllambda,logZ,filters);
	end
