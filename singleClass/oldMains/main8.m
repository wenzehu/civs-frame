...
tic
[filterIndex, lambdaIndex]= mexc_IndexGenerator(numFilter, size(img,1),size(img,2),filters);
disp(['finished generating index : ' num2str(toc) ' seconds']);
